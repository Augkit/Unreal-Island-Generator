...
FDelaunayTriangle UDelaunayHelper::ConvertTriangleIDToTriangle(const FDelaunayMesh& Triangulation, FTriangleIndex TriangleIndex)
{
	...
	// aIndex = Triangulation.DelaunayTriangles[TriangleIndex * 3];
	// bIndex = Triangulation.DelaunayTriangles[TriangleIndex * 3 + 1];
	// cIndex = Triangulation.DelaunayTriangles[TriangleIndex * 3 + 2];
