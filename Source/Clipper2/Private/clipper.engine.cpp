...
// https://github.com/AngusJohnson/discussions/334
...
namespace Clipper2Lib {
  ...
  struct HorzSegSorter {
    ...
    {
      if (!hs1.right_op || !hs2.right_op) return static_cast<bool>(hs1.right_op);
  ...
  {
    return static_cast<bool>(e.outrec);
  }
  ...
  inline bool UpdateHorzSegment(HorzSegment& hs)
  {
    ...
    bool outrecHasEdges = static_cast<bool>(outrec->front_edge);
